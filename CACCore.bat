...
REM   8 Exile Altis
REM   9 Antistasi S.O.G. Prarie Fire
REM   10 Dynamic Recon Ops CUP
echo.
echo  9 CAC Settings
echo.
...
REM IF ERRORLEVEL 10 GOTO DynamicReconOps
REM IF ERRORLEVEL 9 GOTO PrarieFire
REM IF ERRORLEVEL 8 GOTO ExileAltis
...
GOTO End
:KPLibExtended
%A5% -port=2100 "%KPLib%%o1%%o2%%o4%%o5%%o6%"
GOTO End
